[![Build Status](https://github.com/strimzi/drain-cleaner/actions/workflows/build.yml/badge.svg?branch=main)](https://github.com/strimzi/drain-cleaner/actions/workflows/build.yml?query=branch%3Amain)
